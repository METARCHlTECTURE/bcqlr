...
### 入 Church of Elleh  艾雷教堂，遇 Merchant Kalé “流浪商人”咖列
...
### 在 Agheel Lake North 南，遇 Boc the Seamster 亚人柏克
...
### 在 Mistwood Outskirts 东北，遇 Kenneth Haight 肯尼斯·海德
...
**传送至 Fort Haight，对话 Kenneth Haight, Limgrave Heir**
...
### 解锁 Divine Tower of Limgrave 宁姆格福神授塔

## Groundtable Hold 圆桌厅堂在击败 Godrick the Grafted “接肢”葛瑞克后的变化

### 在 Stormhill Shack 风暴山丘的破屋，再次对话 罗德莉卡
...
### Nepheli Loux, Warrior 战士涅斐丽·露移动至 Roundtable Hold 圆桌厅堂

## 入 Liurnia of the Lakes 利耶尼亚区

### 击杀 Godrick the Grafted “接肢”葛瑞克后， White Mask Varré “白面具”梵雷移动到  Liurnia of the Lakes 利耶尼亚

### 遭遇 Rennala, Queen of the Full Moon “满月女王”蕾娜菈
...
### 二阶段  Rennala, Queen of the Full Moon “满月女王”蕾娜菈
...
### Rennala, Queen of the Full Moon “满月女王”蕾娜菈成为友方 NPC
...
### 早期现代英语（Early Modern English）的第二人称代词

| 人称 | 主格 | 宾格 | 物主形容词 | 物主名词 | 反身代词 |
| ---- | ---- | ---- | --------- | ------ | ------ |
| 单数 | thou | thee | thy/thine（后接 元音/h 开头词） | thine | thyself |
| 复数 | ye | you | your | yours | yourselves |
...
无论该单词有多少个音节（syllable），其重读音节只有一个，而且都在元音上，辅音不重读。单音节词也重读，只是省略了重音符号。比如：book, be'gin, 'beautiful。

规律 2：双音节名词的重音一般在第一个音节，例如：'present, 'export。

规律 3：双音节形容词的重音一般在第一个音节，例如：'clever, 'slender。

规律 4：双音节动词的重音一般在第二个音节，例如：re'cord, in'crease。但是也有例外，特例：'borrow, 'travel。

注意：英语中有的单词拼写相同，但如果重音位置不同，词性就不同，只是其基本含义是相同的。例如：im'port（动词）'import（名词）

规律 5：以 -ly 或 -er 结尾的三音节副词重音一般在第一个音节（有例外），例如：'recklessly, 'instantly, 'gardener, 'carpenter。

规律 6：以 -sion / tion / cian / ic / ious / ient / ial / ia / ish 结尾的单词，其重音往往在倒数第二个音节，例如：de'cision, organi'zation, org'anic, musi'cian, no'torious, im'patient, fi'nancial, in'somnia, es'tablish。

规律 7：以 -cy / gy / phy / ty / al 结尾的单词，其重音往往在倒数第三个音节上，例如：de'mocracy, bi'ology, ge'ography, possi'bility, indis'pensable。

规律 8：以后缀 -ade / ee / eer / ese / oon / que 等结尾的单词，重音很多都在这个后缀音节上，例如：cru'sade, guaran'tee, marke'teer, Japa'nese, phy'sique, car'toon。
